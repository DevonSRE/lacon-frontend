...
export default function LawyersRequest() {
  ...
  useEffectAfterMount(() => {
    if (state && CLIENT_ERROR_STATUS.includes(state?.status)) {
      ...
      setDetailsDailog(false);
    queryClient.invalidateQueries({ queryKey: ["getLawyersRequest"] });
  ...
  const actionType: string[] = ["Creation", "Suspension", "approve"];
      ...
      <div className="flex flex-1 flex-col gap-6 pt-0 mx-4 lg:mx-0">
        <div className="row flex justify-between">
          ...
          <Button
            ...
            className="bg-red-600 hover:bg-red-700 text-white h-11 rounded-sm"
          >
        ...
        <DataTable
          onRowClick={handleOpenDetailsSheet}
          columns={columns}
          loading={isLoading}
          data={data?.data.data}
        />
        ...
        >
          <div className="mt-4">
            ...
            <div className="space-y-4">
              ...
              <DetailItem
                label="Requested By:"
                value={selectedUser?.RequestedName ?? ""}
              />
              ...
              <div>
                ...
                <Card className="mt-2 bg-gray-100">
                  <CardContent className="text-sm text-gray-800">
                    Request to add new staff lawyer to handle increased caseload
                    in civil justice department. Lawyer has 5 years experience
                    in civil litigation.
                  </CardContent>
                </Card>
              </div>
            ...
            <div className="mt-6 grid grid-cols-3 gap-4">
              <Button
                className="bg-green-700 hover:bg-green-800 h-12 w-full"
                onClick={() => {
                  setDetailsDailog(false);
              ...
              <Button
                variant="outline"
                onClick={() => setDetailsDailog(false)}
                className="h-12 w-full"
              >
                No, Cancel
              </Button>
        ...
        >
          <div className="space-y-5">
            ...
            <div className="justify-center text-center">
              Are You Sure You Want To Approvet this request
            </div>
            <div className="p-1">
              <TextAreaField
                name="reason"
                ...
                className="focus:ring-black-500 border-black"
                label=""
                placeholder="Add any note for the record"
              />
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <Button
                ...
                className="w-full h-11 bg-[#006458] text-white border-0"
              >
                {isPending ? "Approving..." : " Yes, Approve"}
              </Button>
              <Button
                variant={"outline"}
                className="w-full h-11 border-black border-2"
                onClick={() => setApproveDailog(false)}
              >
                No, Cancel
              </Button>
            </div>
        ...
        >
          <div className="mt-4">
            <div className="space-y-5">
              ...
              <div className="justify-center text-center">
                Please confirm you want to reject this request
              </div>
              <div className="p-1">
                <TextAreaField
                  name="reason"
              ...
              <div className="grid grid-cols-2 gap-4">
                <Button
                  disabled={isPending}
                  onClick={() => dispatchAction("reject")}
                  className="w-full h-11 bg-red-500 text-white border-0  "
                >
