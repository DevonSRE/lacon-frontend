...
export function AddUserSheet() {
    const { isOpen, setIsOpen, openLoadingDialog, setLoadingDialog } = useAction();
    ...
    return (
        <>
            <LoadingDialog
                ...
                onOpenChange={(open) =>
                    setLoadingDialog((prev) => ({ ...prev, open }))
                }
                        ...
                        <>
                            ...
                            {formData.user_type === "LACON LAWYER" && (
                                <div className="space-y-1">
                                    ...
                                    <Select key={formData.designation + state?.status} name="designation" value={formData.designation} onValueChange={(val) => handleChange("designation", val)}>
                                        <SelectTrigger className="w-full  rounded-none h-11">
                            ...
                            {/* Zone Selection */}
                            {(formData.user_type === "ZONAL DIRECTOR" || formData.designation === "CENTRE COORDINATOR" || formData.designation === "Zonal Office") && (
                                <div className="space-y-1">
                                    <Label>
