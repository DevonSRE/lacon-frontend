...
export const createCaseColumns = (
  ...
  if (userRole === ROLES.PLATFORM_ADMIN || userRole === ROLES.INTERNAL_PARALEGAL || userRole === ROLES.DIRECTOR_GENERAL) {
    columns.push({
...
export const InternalCaseColumns = (
  userRole: ROLES,
  onAssign: (caseItem: ICase) => void,
  onReAssign: (caseItem: ICase) => void,
  onReview: (caseItem: ICase) => void,
...
export const InternalCaseASSignColumns = (
  userRole: ROLES,
  onAssign: (caseItem: ICase) => void,
  onReAssign: (caseItem: ICase) => void,
  onReview: (caseItem: ICase) => void,
