...
const Input: FC<InputProps> = ({
  ...
  let inputClasses = `w-full h-11 rounded-sm border-2 appearance-none px-4 py-2.5 text-sm shadow-theme-xs placeholder:text-gray-400  dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30  ${className}`;
